...
const css = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .field input {
    ...
    padding: 10px 14px; font-size: 14px; color: #f1f5f9; outline: none;
  ...
  .btn-primary {
    ...
    padding: 11px; font-size: 14px; font-weight: 600; color: #fff;
    cursor: pointer; margin-top: 8px; transition: background 0.15s, opacity 0.15s;
  }
  ...
  .btn-secondary {
    width: 100%; background: #0f172a; border: 1px solid #334155; border-radius: 8px;
    padding: 10px; font-size: 13px; font-weight: 500; color: #94a3b8;
  ...
  .terms { font-size: 12px; color: #475569; margin-top: 16px; text-align: center; line-height: 1.6; }
  .terms a { color: #10b981; text-decoration: none; cursor: pointer; }
  ...
  .check-box { width: 16px; height: 16px; border-radius: 4px; border: 2px solid #475569; background: #0f172a; flex-shrink: 0; margin-top: 1px; display: flex; align-items: center; justify-content: center; transition: all 0.15s; }
  .check-box.checked { background: #10b981; border-color: #10b981; }
  .check-box svg { width: 9px; height: 9px; stroke: #fff; stroke-width: 3; fill: none; stroke-linecap: round; stroke-linejoin: round; }
`;
                ...
                <form onSubmit={handleSubmit}>
                    <div className="field-row-2">
                        <div className="field">
                            ...
                            <input type="text" placeholder="Jane" value={form.firstName} onChange={set("firstName")} autoComplete="given-name" />
                        </div>
                        <div className="field">
                        ...
                        {form.password && (
                            <div className="pw-strength">
                                <div className="pw-strength-bar">
                                    {[0, 1, 2, 3].map(i => (
                                        <div key={i} className={cx("pw-segment", strengthClass(i, strength))} />
                                    ))}
                                </div>
                    ...
                    <div className="field">
                        ...
                        <div className="input-wrap">
                            <input
                                ...
                                className={cx("has-toggle", passwordsMismatch ? "invalid" : "")}
                                autoComplete="new-password"
                            />
